   ...
   layout(title = 
         ...
         yaxis = 
           list(title = 
                  "Mean Snowfall (mm)"))
```
Analysis of Barplot: Barplot indicates that for specific months in 1997 the snow data was not recorded or there was no snow for those specific months because in our dataset, specific months contained zero for snowfall (mm). 
